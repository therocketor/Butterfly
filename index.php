...
<html class="loading">
  <head>
    ...
    <title>CYBER PIRATES CHECKER </title>
		...
		<div class="col-md-8">
			<div class="card">
				<div class="card-body text-center">
					...
					<a class="nav-link btn btn-success create-new-button" id="createbuttonDropdown" data-toggle="dropdown" aria-expanded="false" href="https://telegram.dog/hackingcourseschat">CLICK HERE TO JOIN OUR GROUP </a> <br>
					<textarea rows="6" class="form-control text-center form-checker mb-2" placeholder="PUT YOUR CC HERE :>"></textarea>
					
	<br>	
<a class="nav-link btn btn-success create-new-button" id="createbuttonDropdown" data-toggle="dropdown" aria-expanded="false" href="https://telegram.dog/hackingcourseuz">GET FREE STUFF JOIN HERE </a> <br>		
...
Swal.fire({ title: "@hackingcourseuz", text: "Join Our Telegram Channel :(", icon: "warning", confirmButtonText: "OK", buttonsStyling: false, confirmButtonClass: 'btn btn-primary'});
